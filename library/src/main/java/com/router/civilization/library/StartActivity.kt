...
import com.router.civilization.library.bean.TabEntity
...
import com.router.civilization.library.mvp.presenter.MainPresenter
import com.router.civilization.library.ui.fragment.*
import com.router.civilization.library.update.DownLoadBuilder
import com.router.civilization.library.update.UpdateActivity
import com.router.civilization.library.utils.*
...
on 2020/1/15.
 */
class StartActivity : BaseActivity(), MainContract.View {
    ...
    override fun initView() {
        initWhiteActionBar(View.VISIBLE, null, "开始")
        initTab()
    ...
    internal inner class DownloadCompleteBroadcast : BroadcastReceiver() {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            if (intent.action == DownloadManager.ACTION_DOWNLOAD_COMPLETE) {
                DownLoadBuilder.intallApk(this@StartActivity, PackageManage.getAppProcessName(context))
            }
        }
    }
